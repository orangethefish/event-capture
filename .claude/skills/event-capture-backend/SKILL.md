...
2. Read `.agents/docs/BACKEND_IMPLEMENTATION_PLAN.md` for target backend architecture and `.agents/docs/APPLICATION_COMPLETION_PLAN.md` for the dependency-ordered audited completion work when the task touches planned behavior.
...
- Treat `.agents/docs/BACKEND_IMPLEMENTATION_PLAN.md` as target architecture and `.agents/docs/APPLICATION_COMPLETION_PLAN.md` as the active audited completion sequence, not as claims about current behavior.
